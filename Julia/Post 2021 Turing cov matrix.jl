...
updated_date = "February 18, 2022"
day_title = "February 18, 2022"
update_date = Date(2022, 02, 18)
value_date = Date(2022, 02, 18)
...
end_election = Vector([.326, .337, 0.178, 0.076, 0.023, 0.049, 0.011]) 
...
savefig(plt, "Images/can_vote_intention_2019_2021_post_election.png")
...
savefig(plt_house_effects, "Images/house_effects_pollsters_2019_2021.png")
...
savefig(plt_2019, "Images/can_vote_intention_2019_post_2021.png")
...
savefig(plt_dens, "Images/can_vote_intention_post_2021.png")
